 ...
 * 1) Set a break point in MyLittleGeneratorGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class MyLittleGeneratorGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("my-little-generator") // use this codegen library
              ...
              .setOutputDir("out/my-little-generator"); // output directory

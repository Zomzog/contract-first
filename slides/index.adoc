...
--
image:twitter.png[twitter, width=50] twitter.com/Zomzog
...
Je parles ici d'une petite applicaton, dans la vrai vie on se retrouve souvent avec beaucoup de backends qui communiquent aussi entre eux.
